...
# Multi-arch support: Get platform information
ARG TARGETPLATFORM
ARG TARGETOS
ARG TARGETARCH
...
# Add kubectl for the kube apply plugin - multi-arch support
...
# Add cnoe-cli - multi-arch support
RUN CNOE_ARCH=$(case ${TARGETARCH} in \
        amd64) echo "x86_64" ;; \
        arm64) echo "arm64" ;; \
        *) echo "x86_64" ;; \
    esac) && \
